...
class IncidentNeutron(EqualityMixin):
    ...
    fission_energy : None or FissionEnergyRelease
    ...
    resonances : Resonances or None
        Resonance parameters
    resonance_covariance : ResonanceCovariance or None
    ...
    def add_temperature_from_ace(self, ace_or_filename, metastable_scheme='nndc'):
        ...
        Parameters
        ----------
        ace_or_filename : ace.Table or str
    ...
    def from_endf(cls, ev_or_filename, covariance=False):
        ...
        Parameters
        ----------
        ev_or_filename : endf.Evaluation or str
    ...
    def from_njoy(cls, filename, temperatures=None, **kwargs):
        ...
        **kwargs
            Keyword arguments passed to :func:`njoy.make_ace`
